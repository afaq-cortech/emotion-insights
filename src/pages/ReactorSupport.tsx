...
export default function ReactorSupport() {
    ...
    <div className="min-h-screen bg-gradient-subtle">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Get help and support for your reactor activities
                </p>
              </div>
            </div>
            {profile && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="shadow-card">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              This page will contain reactor support functionality. Content coming soon...
            </p>
          </CardContent>
        </Card>
      </main>
